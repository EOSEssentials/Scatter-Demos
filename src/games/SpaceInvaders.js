...
export function setupInvader (invader) {
...
export function collisionHandler (bullet, alien) {
...
export function enemyHitsPlayer (player,bullet) {
...
export function resetBullet (bullet) {
